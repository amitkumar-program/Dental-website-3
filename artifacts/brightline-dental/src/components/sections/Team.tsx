...
const team = [
  ...
  {
    name: "Dr. Priya Nandan, DDS",
    role: "Pediatric Dentistry",
    bio: "Dr. Nandan specialises in making young patients feel safe, happy, and excited about dental visits.",
    image: drPriya,
  }
];
            ...
            >
              <div className="bg-white rounded-3xl p-4 shadow-sm border border-border/50 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <div className="px-2 pb-2">
                  ...
                  {/* Bio reveals fully on hover (for desktop) or is just static */}
